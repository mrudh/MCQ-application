from mcq import menu, print_results, quiz_by_difficulty, age_based_quiz, fifty_fifty_quiz, take_quiz_with_skip, take_fill_in_the_blanks_quiz, take_quiz_with_summary, quiz_by_topic
